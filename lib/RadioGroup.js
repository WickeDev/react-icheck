...
var RadioGroup = /** @class */ (function (_super) {
    ...
    RadioGroup.prototype.render = function () {
        ...
        var options = React.Children.map(this.props.children, function (child) {
            ...
            return (React.createElement(Radio_1.Radio, __assign({}, other, { name: name, value: value, label: label, onChange: _this.handleChange.bind(_this), checked: option.props.value === _this.state.value })));
        });
