...
var RadioGroup = /** @class */ (function (_super) {
    ...
    RadioGroup.prototype.render = function () {
        ...
        var options = React.Children.map(this.props.children, function (child) {
            var option = child;
            var _a = option.props, name = _a.name, value = _a.value, label = _a.label, onChange = _a.onChange, other = __rest(_a, ["name", "value", "label", "onChange"]);
            // key={option.props.value.current.key}
            // ref={option.props.value}
            return (React.createElement(Radio_1.default, __assign({}, other, { name: _this.props.name, value: option.props.value, label: option.props.label, onChange: _this.handleChange.bind(_this), checked: option.props.value === _this.state.value })));
        });
