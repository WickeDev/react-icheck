...
var EnhancedSwitch = /** @class */ (function (_super) {
    ...
    EnhancedSwitch.prototype.render = function () {
        ...
        var insertType = typeof props.insert;
        var insertElement = (props.insert && insertType === "string" && !React.isValidElement(props.insert)) ?
            (React.createElement("div", { dangerouslySetInnerHTML: { __html: props.insert } })) : React.createElement("div", null);
